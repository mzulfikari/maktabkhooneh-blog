...
@pytest.fixture
def common_user():
    user = User.objects.create_user(email="admin@admin.com",password="a/@12345678",is_verified=True)
    return user
...
class TestPostApi:
    ...
    def test_create_post_response_200_status(self,api_client,common_user):
        url = reverse("blog:api-v1:post-list")
        data = {
            "title": "test",
            "content": "description",
